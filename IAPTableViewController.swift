        ...
        SwiftyStoreKit.purchaseProduct(Bundle.main.bundleIdentifier! + "." + purchase.rawValue, completion: {
            ...
            if case .success(let product) = result {
                if product.productId == Bundle.main.bundleIdentifier! + "." + "Triadic_IAP"{
                    UserDefaults.standard.set(1, forKey: "MulticolorFitting.splitComplementaryPurchased")
                    UserDefaults.standard.set(1, forKey: "MulticolorFitting.splitComplementaryCheck")
